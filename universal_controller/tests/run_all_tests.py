...
print("=" * 60)
print("Universal Controller v3.17.12 - Test Suite")
print("=" * 60)

print("\n[1/8] Running Core Tests...")
print("-" * 40)
...
print("\n[3/8] Running TF2 Transform Tests (F3)...")
print("-" * 40)
...
print("\n[4/8] Running Attitude Controller Tests (F14)...")
print("-" * 40)
...
print("\n[6/8] Running EKF Estimator Tests...")
print("-" * 40)
...
print("\n[8/8] Running System Usability Tests...")
print("-" * 40)
