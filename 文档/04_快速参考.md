...
from universal_controller.tests.test_data_generator import create_test_trajectory, create_test_odom
...
# 超时配置 (Watchdog)
config['watchdog'] = {
    'odom_timeout_ms': 200,       # 里程计超时 (ms) [1-10000]
    'traj_timeout_ms': 200,       # 轨迹超时 (ms) [1-10000]
    'traj_grace_ms': 100,         # 轨迹宽限期 (ms)
    'imu_timeout_ms': 100,        # IMU 超时 (ms) [1-10000]
...
config['mpc'] = {
    ...
    'weights': {
        ...
        'control_v': 0.1,         # 速度控制平滑权重 [≥0]
        'control_omega': 0.1,     # 角速度控制平滑权重 [≥0]
    },
